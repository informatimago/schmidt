...
class ModelController: NSObject, UIPageViewControllerDataSource {
    ...
    func viewControllerAtIndex(_ index: Int, storyboard: UIStoryboard) -> UIViewController? {
        ...
        if(index==0){
            return storyboard.instantiateViewController(withIdentifier: "DesktopViewController") as! DesktopViewController;
        }else{
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        if (index == 0) || (index == NSNotFound) { // first or not found: no previous.
            return nil
        }
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
        ...
        index += 1
        if index == self.pageData.count { // last: no following.
            return nil
        }
        return self.viewControllerAtIndex(index, storyboard: viewController.storyboard!)
    }
